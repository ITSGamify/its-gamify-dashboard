...
export const useAccountPage = () => {
  ...
  const roleParams = searchParams.get("roles") ?? null;
  ...
  const getAccountsReq = {
    ...
    departments: deparmentParams
      ? JSON.stringify(deparmentParams.split("."))
      : null,
    roleId: roleParams ? roleParams : null,
