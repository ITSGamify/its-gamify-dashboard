...
interface PreviewPublishFormProps {
  courseData: CourseDataProps;
  modules: Module[];
}

const PreviewPublishForm: React.FC<PreviewPublishFormProps> = ({
  courseData,
  modules,
}) => {
    ...
    <Grid container spacing={3}>
      ...
      <Grid size={{ xs: 12 }}>
        <Alert severity="info" sx={{ mb: 0 }}>
          Xem lại thông tin khóa học của bạn trước khi xuất bản. Bạn có thể quay
          lại các bước trước để chỉnh sửa nếu cần.
        </Alert>
      </Grid>
        ...
        <Card sx={{ mb: 3 }}>
          ...
          <CardContent>
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 2 }}>
              <Chip label={courseData.category || "Danh mục"} color="primary" />
              <Chip
                label={
              ...
              {courseData.hasCertificate && (
                <Chip label="Có chứng chỉ" variant="outlined" color="success" />
              )}
            </Box>
        ...
        <Card sx={{ mb: 3 }}>
          <CardContent>
            ...
            >
              <ListItem>
                ...
                <ListItemText
                  ...
                  secondary={
                    isBasicInfoComplete ? "Đã hoàn thành" : "Chưa hoàn thành"
                  }
                />
              </ListItem>
            ...
            <Typography
              ...
              sx={{ mt: 1, mb: 3 }}
            >
              Khi xuất bản, khóa học sẽ hiển thị cho học viên và có thể được tìm
              kiếm
            </Typography>
            ...
            {!(isBasicInfoComplete && isContentComplete) && (
              <Alert severity="warning" sx={{ mt: 2 }}>
                Vui lòng hoàn thành tất cả các phần trước khi xuất bản khóa học
              </Alert>
            )}
          </CardContent>
        </Card>
